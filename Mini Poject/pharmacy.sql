...
drop table mediquipment CASCADE CONSTRAINTS;
...
insert into pharmacy values(1,'gokhul_shop_1','chennai',212-9765433,9001002003);
insert into pharmacy values(2,'gokhul_shop_2','mumbai',222-9838212,9001002004);
insert into pharmacy values(3,'gokhul_shop_3','bangalore',233-9812113,9001002001);
insert into pharmacy values(4,'abhi_shop_1','delhi',235-9862263,9010126387);
insert into pharmacy values(5,'abhi_shop_2','chennai',248-9818181,9661268268);
insert into pharmacy values(6,'abhi_shop_3','bangalore',253-9866547,9662312312);
insert into pharmacy values(7,'hemanth_shop_1','bangalore',258-9001536,9234234110);
insert into pharmacy values(8,'heamnth_shop_2','mysore',287-9112543,9235231510);
insert into pharmacy values(9,'hemanth_shop_3','chennai',284-9112541,9878685412);

insert into doctor values(10,'gokhul','cardiologists',45,9831312512,'m');
insert into doctor values(11,'abhishek','diabetologists',50,9826263264,'m');
insert into doctor values(12,'hemanth','gynaecologists',30,9006001002,'m');
insert into doctor values(13,'ajay','hygienists',32,9875400500,'m');
insert into doctor values(14,'gowtham','leprologists',28,9861621312,'m');
insert into doctor values(15,'akashya','neurologists',28,9811254112,'f');
insert into doctor values(16,'anisha','neurologists',24,9831054112,'f');
insert into doctor values(17,'Ajay Solanki','pathologists',32,9811211311,'m');
insert into doctor values(18,'sherif','psychiatrists',31,9006112534,'m');
insert into doctor values(19,'Salman kapoor','sexologists',32,9110110221,'f');


insert into customer values(100,'anshu','m','cheanni',9002001004,21,10);
...
insert into customer values(104,'niru','f','bangalore',9840050024,13,14);
insert into customer values(105,'reshma','f','bangalore',9840050028,22,14);
insert into customer values(106,'rekha','f','kerala',9840050026,35,15);
insert into customer values(107,'alisha','f','pune',9840050027,50,16);
insert into customer values(108,'sonia','f','ooty',9840050021,57,14);
insert into customer values(109,'vishaka','m','agra',9821246112,41,17);
...
update mediquipment set price=300
  	where cid in (select cid
  		      from manufacturer
  		      where city='pune');


select p.name,pharid,count(distinct cid) as count1
...
create procedure update_medi as
    begin
